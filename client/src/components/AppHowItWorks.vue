  ...
  <section class="w-9/12 mx-auto mt-5 bg-white">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">Простой и прозрачный процесс подбора персонала</p>
      </div>
      <div class="mb-20">
        ...
        <div class="flex flex-wrap -mx-4">
          <div 
            ...
            :key="'emp'+index" 
            class="w-full md:w-1/2 lg:w-1/4 px-4 mb-8"
          >
            <div class="flex flex-col items-center justify-between bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 h-full">
              <div class="flex items-center mb-4">
                <div class="bg-primary-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4">
                  {{ index + 1 }}
                </div>
              ...
              <div class="bg-primary-50 rounded-lg p-3 w-full">
                <div class="flex items-center">
                  ...
                  <span class="text-sm font-medium text-primary-600">{{ step.time }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div 
            ...
            class="w-full md:w-1/2 lg:w-1/4 px-4 mb-8"
          >
            <div class="bg-gradient-to-br from-white to-primary-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 h-full">
              <div class="bg-primary-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                <svg class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path v-if="index === 0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                  <path v-if="index === 1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                  <path v-if="index === 2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z"/>
