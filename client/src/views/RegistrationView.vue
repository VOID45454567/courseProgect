            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <button @click="selectRole('searcher')" :class="[
                            'w-1/2 py-3 rounded-xl border-2 font-bold transition-all duration-300 cursor-pointer',
                            formData.role === 'searcher'
                                ? 'bg-primary-500 text-white border-primary-500 shadow-md'
                                : 'border-primary-500 text-primary-500 hover:bg-primary-50',
                        ]">
                            Соискатель
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input type="checkbox" v-model="agreeToPolicy" @change="validatePolicy()"
                    ...
                    <div class="ml-3 text-sm">
                        <label class="font-medium text-gray-700">
                            Я принимаю
                            <span class="text-primary-500 cursor-pointer hover:underline">Политику
                                конфиденциальности</span>
                        </label>
                        <p v-if="errors.agreeToPolicy" class="mt-1 text-sm text-red-600">
                ...
                <div class="text-gray-600 my-0">Уже есть аккаунт?</div>
...
export default {
    data() {
        return {
            colums: ["name", "surname", "midname", "email", "password", "passwordRepeat"],
            formData: {
                name: "",
                surname: "",
                midname: "",
