<template>
    <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <!-- Заголовок -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Резюме</h1>
            </div>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <p class="my-2 text-2xl font-semibold text-primary-600">100 000 ₽/мес</p>
                    </div>

                    <div class="flex flex-wrap gap-2 mb-5">
                        <span class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">Опыт
                            3 года</span>
                        <span class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">Vue
                            3</span>
                        <span
                            class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">TypeScript</span>
                    </div>

                    <div class="mb-5">
                        <p class="text-gray-600">
                            Frontend разработчик с опытом работы с Vue 3, Composition API, Pinia.
                            Участвовал в разработке 5+ коммерческих проектов.
                        </p>
                    </div>

                    <div class="flex items-center gap-3 mb-6">
                        <div>
                            <p class="font-medium text-gray-800">Иван Иванов</p>
                            <div class="flex items-center text-gray-500 text-sm">
                                ...
                                <span>Москва, готов к переезду</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-gray-400 text-sm">5 дней назад</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <p class="my-2 text-2xl font-semibold text-primary-600">120 000 ₽/мес</p>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-5">
                        <span class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">Опыт
                            4 года</span>
                        <span
                            class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">React</span>
                        <span
                            class="bg-primary-500/10 text-primary-600 px-3 py-1 rounded-full text-sm font-medium">Redux</span>
                    </div>

                    <div class="mb-5">
                        <p class="text-gray-600">
                            Senior React разработчик с опытом создания сложных SPA-приложений. Знание
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        <div>
                            <p class="font-medium text-gray-800">Петр Петров</p>
                            <div class="flex items-center text-gray-500 text-sm">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                ...
                                <span>Санкт-Петербург, удалённо</span>
                            </div>
                        </div>
                    </div>
